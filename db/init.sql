...
CREATE INDEX IF NOT EXISTS idx_companies_is_target ON companies (is_target);
...
CREATE INDEX IF NOT EXISTS idx_financial_data_fetched_at ON financial_data (fetched_at);
...
CREATE INDEX IF NOT EXISTS idx_sentiment_scores_company_id ON sentiment_scores (company_id);
...
CREATE INDEX IF NOT EXISTS idx_scrape_log_job_name ON scrape_log (job_name);
